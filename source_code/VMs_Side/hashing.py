...
class ScryptHash:
    ...
    def __init__(self, plaintext_password: str, salt: Optional[bytes] = None):
        ...
        self.hash = scrypt.hash(plaintext_password.encode(), self.salt, 32768, buflen=self.HASH_SIZE)
    ...
    def create_b64_hash(self) -> str:
        ...
        return f'{b64_salt}{self.SEP}{b64_hash}'
    ...
    def create_from_b64(cls, b64_password: str) -> 'ScryptHash':
        b64_salt, b64_scrypt_hash = b64_password.split(cls.SEP, 1)
